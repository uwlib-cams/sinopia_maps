...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="qaLinks">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$node = 'urn:ld4p:sinopia:rda:work'">
                <xsl:text>Sinopia RDA monograph work</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:sinopia:rda:expression'">
                <xsl:text>Sinopia RDA monograph expression</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:sinopia:rda:manifestation'">
                <xsl:text>Sinopia RDA monograph manifestation</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:sinopia:rda:item'">
                <xsl:text>Sinopia RDA monograph item</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="$node = 'urn:ld4p:qa:locvocabs:mscript'">
                <a href="https://id.loc.gov/vocabulary/mscript.html">
                    <xsl:text>LOC script [vocabularies] (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
                <xsl:text>locvocabs_ld4l_cache</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="$node = 'urn:ld4p:qa:gettyaat:Agents'">
                <a href="https://www.getty.edu/research/tools/vocabularies/aat/index.html">
                    <xsl:text>GETTY_AAT Agents (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
                <xsl:text>getty_aat_ld4l_cache</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:qa:gettyaat:Agents'">
                <a href="https://www.getty.edu/research/tools/vocabularies/aat/index.html">
                    <xsl:text>GETTY_AAT Agents__People (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
                <xsl:text>getty_aat_ld4l_cache</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:qa:gettyaat:Agents__People'">
                <a href="https://www.getty.edu/research/tools/vocabularies/aat/index.html">
                    <xsl:text>GETTY_AAT Agents__People (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
            ...
            <xsl:when test="$node = 'urn:ld4p:qa:gettyaat:Agents__Organizations'">
                <a href="https://www.getty.edu/research/tools/vocabularies/aat/index.html">
                    <xsl:text>GETTY_AAT Agents__Organizations (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
                <xsl:text>getty_aat_ld4l_cache</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:qa:gettyulan:person'">
                <a href="https://www.getty.edu/research/tools/vocabularies/ulan/index.html">
                    <xsl:text>GETTY_ULAN person (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
                <xsl:text>getty_ulan_ld4l_cache</xsl:text>
            </xsl:when>
            <xsl:when test="$node = 'urn:ld4p:qa:gettyulan:organization'">
                <a href="https://www.getty.edu/research/tools/vocabularies/ulan/index.html">
                    <xsl:text>GETTY_ULAN organization (QA)</xsl:text>
                </a>
                <xsl:copy-of select="$viaQaText"/>
                <xsl:text>getty_ulan_ld4l_cache</xsl:text>
            </xsl:when>
